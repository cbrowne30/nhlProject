...
class TestTeamStatsStatsInnerSplitsInner(unittest.TestCase):
    """TeamStatsStatsInnerSplitsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamStatsStatsInnerSplitsInner:
        """Test TeamStatsStatsInnerSplitsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamStatsStatsInnerSplitsInner`
        """
        model = TeamStatsStatsInnerSplitsInner()
        if include_optional:
            return TeamStatsStatsInnerSplitsInner(
    ...
    def testTeamStatsStatsInnerSplitsInner(self):
        """Test TeamStatsStatsInnerSplitsInner"""
