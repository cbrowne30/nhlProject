...
class TestGameContentHighlights(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GameContentHighlights:
        """Test GameContentHighlights
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameContentHighlights`
        """
        model = GameContentHighlights()
        if include_optional:
            return GameContentHighlights(
                ...
                game_center = openapi_client.models.game_highlights.GameHighlights(
                    scoreboard = openapi_client.models.game_highlight_type.GameHighlightType(
                        title = 'Highlights', 
                        topic_list = '293642378', 
                        items = [
                            openapi_client.models.game_highlight.GameHighlight(
