...
class TestGameHighlightType(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GameHighlightType:
        """Test GameHighlightType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameHighlightType`
        """
        model = GameHighlightType()
        if include_optional:
            return GameHighlightType(
                title = 'Highlights',
