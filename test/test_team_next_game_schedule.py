...
class TestTeamNextGameSchedule(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TeamNextGameSchedule:
        """Test TeamNextGameSchedule
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamNextGameSchedule`
        """
        model = TeamNextGameSchedule()
        if include_optional:
            return TeamNextGameSchedule(
                total_items = 1,
                total_events = 0,
                total_games = 1,
                total_matches = 0,
