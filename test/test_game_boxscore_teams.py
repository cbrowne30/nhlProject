...
class TestGameBoxscoreTeams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GameBoxscoreTeams:
        """Test GameBoxscoreTeams
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameBoxscoreTeams`
        """
        model = GameBoxscoreTeams()
        if include_optional:
            return GameBoxscoreTeams(
