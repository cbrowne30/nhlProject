...
class TestGameEditorials(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GameEditorials:
        """Test GameEditorials
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameEditorials`
        """
        model = GameEditorials()
        if include_optional:
            return GameEditorials(
                title = 'Preview',
                topic_list = '',
                items = [
