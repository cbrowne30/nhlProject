...
class TestGameContentMediaMilestones(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GameContentMediaMilestones:
        """Test GameContentMediaMilestones
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameContentMediaMilestones`
        """
        model = GameContentMediaMilestones()
        if include_optional:
            return GameContentMediaMilestones(
                title = 'Milestones',
