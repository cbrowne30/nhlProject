...
class TestGameContentMediaMilestonesItemsInner(unittest.TestCase):
    """GameContentMediaMilestonesItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameContentMediaMilestonesItemsInner:
        """Test GameContentMediaMilestonesItemsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameContentMediaMilestonesItemsInner`
        """
        model = GameContentMediaMilestonesItemsInner()
        if include_optional:
            return GameContentMediaMilestonesItemsInner(
    ...
    def testGameContentMediaMilestonesItemsInner(self):
        """Test GameContentMediaMilestonesItemsInner"""
