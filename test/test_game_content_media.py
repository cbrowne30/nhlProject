...
class TestGameContentMedia(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GameContentMedia:
        """Test GameContentMedia
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameContentMedia`
        """
        model = GameContentMedia()
        if include_optional:
            return GameContentMedia(
                epg = [
