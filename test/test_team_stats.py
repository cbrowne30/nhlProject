...
class TestTeamStats(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TeamStats:
        """Test TeamStats
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamStats`
        """
        model = TeamStats()
        if include_optional:
            return TeamStats(
                copyright = '',
                stats = [
                    openapi_client.models.team_stats_stats_inner.TeamStats_stats_inner(
