...
class TestTeamNextGameScheduleDatesInnerGamesInner(unittest.TestCase):
    """TeamNextGameScheduleDatesInnerGamesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamNextGameScheduleDatesInnerGamesInner:
        """Test TeamNextGameScheduleDatesInnerGamesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeamNextGameScheduleDatesInnerGamesInner`
        """
        model = TeamNextGameScheduleDatesInnerGamesInner()
        if include_optional:
            return TeamNextGameScheduleDatesInnerGamesInner(
                game_pk = 2017020851,
    ...
    def testTeamNextGameScheduleDatesInnerGamesInner(self):
        """Test TeamNextGameScheduleDatesInnerGamesInner"""
