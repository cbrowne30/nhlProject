...
class TestPlayerStatsStatsInnerSplitsInner(unittest.TestCase):
    """PlayerStatsStatsInnerSplitsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerStatsStatsInnerSplitsInner:
        """Test PlayerStatsStatsInnerSplitsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayerStatsStatsInnerSplitsInner`
        """
        model = PlayerStatsStatsInnerSplitsInner()
        if include_optional:
            return PlayerStatsStatsInnerSplitsInner(
                season = '20172018',
    ...
    def testPlayerStatsStatsInnerSplitsInner(self):
        """Test PlayerStatsStatsInnerSplitsInner"""
