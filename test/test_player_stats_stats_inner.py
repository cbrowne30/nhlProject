...
class TestPlayerStatsStatsInner(unittest.TestCase):
    """PlayerStatsStatsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerStatsStatsInner:
        """Test PlayerStatsStatsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlayerStatsStatsInner`
        """
        model = PlayerStatsStatsInner()
        if include_optional:
            return PlayerStatsStatsInner(
    ...
    def testPlayerStatsStatsInner(self):
        """Test PlayerStatsStatsInner"""
