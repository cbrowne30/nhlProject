...
class PlayersApi:
    ...
    def get_player(
        self,
        id: Annotated[Union[StrictFloat, StrictInt], Field(description="The ID of the player.")],
