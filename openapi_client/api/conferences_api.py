...
class ConferencesApi:
    ...
    def get_conference(
        self,
        id: Annotated[Union[StrictFloat, StrictInt], Field(description="The ID of the conference.")],
