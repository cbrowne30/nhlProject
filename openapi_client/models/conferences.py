...
class Conferences(BaseModel):
    ...
    teams: Optional[List[Conference]] = None
    __properties: ClassVar[List[str]] = ["copyright", "teams"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "teams": [Conference.from_dict(_item) for _item in obj.get("teams")] if obj.get("teams") is not None else None
        })
        return _obj
