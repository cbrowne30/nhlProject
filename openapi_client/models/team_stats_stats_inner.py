...
class TeamStatsStatsInner(BaseModel):
    """
    TeamStatsStatsInner
    """ # noqa: E501
    type: Optional[TeamStatsStatsInnerType] = None
    splits: Optional[List[TeamStatsStatsInnerSplitsInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": TeamStatsStatsInnerType.from_dict(obj.get("type")) if obj.get("type") is not None else None,
            "splits": [TeamStatsStatsInnerSplitsInner.from_dict(_item) for _item in obj.get("splits")] if obj.get("splits") is not None else None
        })
        return _obj
