...
class GameHighlights(BaseModel):
    ...
    GameHighlights
    """ # noqa: E501
    scoreboard: Optional[GameHighlightType] = None
    game_center: Optional[GameHighlightType] = Field(default=None, alias="gameCenter")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "scoreboard": GameHighlightType.from_dict(obj.get("scoreboard")) if obj.get("scoreboard") is not None else None,
            "gameCenter": GameHighlightType.from_dict(obj.get("gameCenter")) if obj.get("gameCenter") is not None else None
        })
        return _obj
