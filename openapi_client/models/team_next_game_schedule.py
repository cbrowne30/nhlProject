...
class TeamNextGameSchedule(BaseModel):
    """
    ...
    dates: Optional[List[TeamNextGameScheduleDatesInner]] = None
    __properties: ClassVar[List[str]] = ["totalItems", "totalEvents", "totalGames", "totalMatches", "dates"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "dates": [TeamNextGameScheduleDatesInner.from_dict(_item) for _item in obj.get("dates")] if obj.get("dates") is not None else None
        })
        return _obj
