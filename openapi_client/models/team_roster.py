...
class TeamRoster(BaseModel):
    ...
    TeamRoster
    """ # noqa: E501
    roster: Optional[List[Roster]] = None
    __properties: ClassVar[List[str]] = ["roster"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "roster": [Roster.from_dict(_item) for _item in obj.get("roster")] if obj.get("roster") is not None else None
        })
        return _obj
