...
class TeamStats(BaseModel):
    ...
    stats: Optional[List[TeamStatsStatsInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "stats": [TeamStatsStatsInner.from_dict(_item) for _item in obj.get("stats")] if obj.get("stats") is not None else None
        })
        return _obj
