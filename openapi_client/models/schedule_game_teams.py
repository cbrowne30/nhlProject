...
class ScheduleGameTeams(BaseModel):
    ...
    ScheduleGameTeams
    """ # noqa: E501
    away: Optional[ScheduleGameTeamsAway] = None
    home: Optional[ScheduleGameTeamsHome] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "away": ScheduleGameTeamsAway.from_dict(obj.get("away")) if obj.get("away") is not None else None,
            "home": ScheduleGameTeamsHome.from_dict(obj.get("home")) if obj.get("home") is not None else None
        })
        return _obj
