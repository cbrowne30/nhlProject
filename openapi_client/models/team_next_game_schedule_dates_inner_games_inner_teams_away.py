...
class TeamNextGameScheduleDatesInnerGamesInnerTeamsAway(BaseModel):
    """
    TeamNextGameScheduleDatesInnerGamesInnerTeamsAway
    """ # noqa: E501
    league_record: Optional[TeamNextGameScheduleDatesInnerGamesInnerTeamsAwayLeagueRecord] = Field(default=None, alias="leagueRecord")
    score: Optional[Union[StrictFloat, StrictInt]] = None
    team: Optional[TeamNextGameScheduleDatesInnerGamesInnerTeamsAwayTeam] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "leagueRecord": TeamNextGameScheduleDatesInnerGamesInnerTeamsAwayLeagueRecord.from_dict(obj.get("leagueRecord")) if obj.get("leagueRecord") is not None else None,
            "score": obj.get("score"),
            "team": TeamNextGameScheduleDatesInnerGamesInnerTeamsAwayTeam.from_dict(obj.get("team")) if obj.get("team") is not None else None
        })
        return _obj
