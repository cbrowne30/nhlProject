...
class TeamNextGameScheduleDatesInnerGamesInner(BaseModel):
    """
    ...
    status: Optional[TeamNextGameScheduleDatesInnerGamesInnerStatus] = None
    teams: Optional[TeamNextGameScheduleDatesInnerGamesInnerTeams] = None
    venue: Optional[GameGameDataVenue] = None
    content: Optional[ScheduleGameContent] = None
    __properties: ClassVar[List[str]] = ["gamePk", "link", "gameType", "season", "gameDate", "status", "teams", "venue", "content"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "status": TeamNextGameScheduleDatesInnerGamesInnerStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None,
            "teams": TeamNextGameScheduleDatesInnerGamesInnerTeams.from_dict(obj.get("teams")) if obj.get("teams") is not None else None,
