...
class ScheduleGameTeamsAway(BaseModel):
    """
    ScheduleGameTeamsAway
    """ # noqa: E501
    league_record: Optional[ScheduleGameTeamsAwayLeagueRecord] = Field(default=None, alias="leagueRecord")
    score: Optional[Union[StrictFloat, StrictInt]] = None
    team: Optional[ScheduleGameTeamsAwayTeam] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "leagueRecord": ScheduleGameTeamsAwayLeagueRecord.from_dict(obj.get("leagueRecord")) if obj.get("leagueRecord") is not None else None,
            "score": obj.get("score"),
            "team": ScheduleGameTeamsAwayTeam.from_dict(obj.get("team")) if obj.get("team") is not None else None
        })
        return _obj
