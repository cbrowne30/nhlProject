...
class TeamNextGameScheduleDatesInnerGamesInnerTeams(BaseModel):
    """
    TeamNextGameScheduleDatesInnerGamesInnerTeams
    """ # noqa: E501
    away: Optional[TeamNextGameScheduleDatesInnerGamesInnerTeamsAway] = None
    home: Optional[TeamNextGameScheduleDatesInnerGamesInnerTeamsHome] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "away": TeamNextGameScheduleDatesInnerGamesInnerTeamsAway.from_dict(obj.get("away")) if obj.get("away") is not None else None,
            "home": TeamNextGameScheduleDatesInnerGamesInnerTeamsHome.from_dict(obj.get("home")) if obj.get("home") is not None else None
        })
        return _obj
