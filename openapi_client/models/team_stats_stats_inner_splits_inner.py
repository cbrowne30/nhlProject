...
class TeamStatsStatsInnerSplitsInner(BaseModel):
    """
    TeamStatsStatsInnerSplitsInner
    """ # noqa: E501
    stat: Optional[TeamStatsStatsInnerSplitsInnerStat] = None
    team: Optional[PlayerCurrentTeam] = None
    __properties: ClassVar[List[str]] = ["stat", "team"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "stat": TeamStatsStatsInnerSplitsInnerStat.from_dict(obj.get("stat")) if obj.get("stat") is not None else None,
