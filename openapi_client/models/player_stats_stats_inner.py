...
class PlayerStatsStatsInner(BaseModel):
    """
    PlayerStatsStatsInner
    """ # noqa: E501
    type: Optional[PlayerStatsStatsInnerType] = None
    splits: Optional[List[PlayerStatsStatsInnerSplitsInner]] = None
    __properties: ClassVar[List[str]] = ["type", "splits"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": PlayerStatsStatsInnerType.from_dict(obj.get("type")) if obj.get("type") is not None else None,
            "splits": [PlayerStatsStatsInnerSplitsInner.from_dict(_item) for _item in obj.get("splits")] if obj.get("splits") is not None else None
        })
        return _obj
