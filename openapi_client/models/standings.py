...
class Standings(BaseModel):
    ...
    records: Optional[List[StandingsRecordsInner]] = None
    __properties: ClassVar[List[str]] = ["copyright", "records"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "records": [StandingsRecordsInner.from_dict(_item) for _item in obj.get("records")] if obj.get("records") is not None else None
        })
        return _obj
