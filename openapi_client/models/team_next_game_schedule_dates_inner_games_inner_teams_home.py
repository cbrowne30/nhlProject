...
class TeamNextGameScheduleDatesInnerGamesInnerTeamsHome(BaseModel):
    """
    TeamNextGameScheduleDatesInnerGamesInnerTeamsHome
    """ # noqa: E501
    league_record: Optional[TeamNextGameScheduleDatesInnerGamesInnerTeamsHomeLeagueRecord] = Field(default=None, alias="leagueRecord")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "leagueRecord": TeamNextGameScheduleDatesInnerGamesInnerTeamsHomeLeagueRecord.from_dict(obj.get("leagueRecord")) if obj.get("leagueRecord") is not None else None,
            "score": obj.get("score"),
