...
class PhotoCuts(BaseModel):
    ...
    at2x: Optional[StrictStr] = None
    at3x: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["aspectRatio", "width", "height", "src", "at2x", "at3x"]
