...
class TeamNextGameScheduleDatesInner(BaseModel):
    """
    ...
    games: Optional[List[TeamNextGameScheduleDatesInnerGamesInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "games": [TeamNextGameScheduleDatesInnerGamesInner.from_dict(_item) for _item in obj.get("games")] if obj.get("games") is not None else None,
