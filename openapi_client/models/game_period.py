...
class GamePeriod(BaseModel):
    ...
    num: Optional[Union[StrictFloat, StrictInt]] = None
    ordinal_num: Optional[StrictStr] = Field(default=None, alias="ordinalNum")
    home: Optional[GamePeriodHome] = None
    away: Optional[GamePeriodAway] = None
    __properties: ClassVar[List[str]] = ["periodType", "startTime", "endTime", "num", "ordinalNum", "home", "away"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "home": GamePeriodHome.from_dict(obj.get("home")) if obj.get("home") is not None else None,
            "away": GamePeriodAway.from_dict(obj.get("away")) if obj.get("away") is not None else None
        })
        return _obj
