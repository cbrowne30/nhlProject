...
class GamePlayPlayersInner(BaseModel):
    """
    GamePlayPlayersInner
    """ # noqa: E501
    player: Optional[GamePlayPlayersInnerPlayer] = None
    player_type: Optional[StrictStr] = Field(default=None, alias="playerType")
    __properties: ClassVar[List[str]] = ["player", "playerType"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "player": GamePlayPlayersInnerPlayer.from_dict(obj.get("player")) if obj.get("player") is not None else None,
            "playerType": obj.get("playerType")
        })
        return _obj
