...
class PlayerStats(BaseModel):
    ...
    stats: Optional[List[PlayerStatsStatsInner]] = None
    __properties: ClassVar[List[str]] = ["copyright", "stats"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "stats": [PlayerStatsStatsInner.from_dict(_item) for _item in obj.get("stats")] if obj.get("stats") is not None else None
        })
        return _obj
